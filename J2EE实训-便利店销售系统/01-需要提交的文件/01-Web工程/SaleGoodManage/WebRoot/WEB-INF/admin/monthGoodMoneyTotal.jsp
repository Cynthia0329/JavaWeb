...
<body >
  <!--查询页面 -->
    <center><font color="red" size="20;">单个商品月利润统计</font></center>
		  ...
		  <tr>
			...
			<td class="search_content_td content_width15">
				        <select id="goodId" name="goodId" style="width:200px;" >
			               ...
			               <c:forEach items="${lists}" var="good">	<!-- 进入该页面时，控制器里已查询了全部商品信息，放入lists中 -->
...
<script type="text/javascript">
	   ...
	   function total(){
		     ...
		     //进入统计单件商品月利润的控制器方法
		     var url="<%=path%>/total/showMonthGoodMoneyTotal?startMonth="+startMonth+"&endMonth="+endMonth+"&goodId="+goodId;
		     $("#totalIframe").attr("src",url);		//加载该框架的数据
